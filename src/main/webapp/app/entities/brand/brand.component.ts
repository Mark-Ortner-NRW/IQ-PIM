...
export class BrandComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.brandService
      ...
      .subscribe(
        (res: HttpResponse<IBrand[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInBrands(): void {
    this.eventSubscriber = this.eventManager.subscribe('brandListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IBrand[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
